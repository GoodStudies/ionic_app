...
export const createDisciplineAnswers = async (data: any, participant: Participant, questions: Question[]) => {
...
export const getDisciplineAnswers = async (participant: Participant, questions: Question[]) => {
